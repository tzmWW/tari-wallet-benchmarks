...
one accepted Mode 2 one-sided send smoke:
`18389397492102525901`. A full funded Esmeralda baseline still requires the
complete B0/S0-S7 matrix; do not treat scaffold cells as performance data.
