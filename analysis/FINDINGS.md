...
schema and is safe to share, but a full funded Esmeralda baseline still requires
the operator to fund the generated wallets and run the live command from the
runbook. Do not treat unfunded or scaffold cells as performance data.
